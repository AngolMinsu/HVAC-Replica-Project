...
#define EXAMPLE_LCD_RGB_BUFFER_NUMS     (1)    ///< Number of frame buffers
#define EXAMPLE_RGB_BOUNCE_BUFFER_SIZE  (EXAMPLE_LCD_H_RES * 12) ///< Size of bounce buffer for RGB data
