...
// HU7 -> MKBD CAN OTA
const uint16_t GDS_CAN_ID_OTA_CONTROL = 0x600;
const uint16_t GDS_CAN_ID_OTA_DATA = 0x601;
const uint16_t GDS_CAN_ID_OTA_FLOW = 0x602;
const uint16_t GDS_CAN_ID_OTA_INFO = 0x603;
const uint8_t GDS_CAN_OTA_TARGET_MKBD = 0x02;
const uint8_t GDS_CAN_OTA_BLOCK_FRAMES = 32;
const uint16_t GDS_CAN_OTA_RESPONSE_TIMEOUT_MS = 500;
const uint16_t GDS_CAN_OTA_SESSION_TIMEOUT_MS = 3000;
const uint8_t GDS_CAN_OTA_MAX_RETRIES = 3;
