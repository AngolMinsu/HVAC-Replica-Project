...
enum CanSignal : uint8_t {
  ...
  CAN_SIGNAL_HU_FOCUS_PREV = GDS_CAN_SIGNAL_HU_FOCUS_PREV,
  CAN_SIGNAL_HU_FOCUS_NEXT = GDS_CAN_SIGNAL_HU_FOCUS_NEXT,
  CAN_SIGNAL_HU_OPEN_HOME = GDS_CAN_SIGNAL_HU_OPEN_HOME,
  CAN_SIGNAL_HU_OPEN_MAP = GDS_CAN_SIGNAL_HU_OPEN_MAP,
  CAN_SIGNAL_HU_OPEN_MEDIA = GDS_CAN_SIGNAL_HU_OPEN_MEDIA
};
