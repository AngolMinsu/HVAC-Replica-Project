...
const char* canSignalToText(uint8_t signal) {
  switch (signal) {
    ...
    case CAN_SIGNAL_PASSENGER_TEMPERATURE: return "PsgTemp";
    case CAN_SIGNAL_MUTE: return "Mute";
    case CAN_SIGNAL_HOME: return "Home";
    case CAN_SIGNAL_MEDIA_MODE: return "MediaMode";
